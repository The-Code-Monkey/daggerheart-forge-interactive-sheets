const Footer = () => {
  return (
    <footer className="bg-purple-900/90 backdrop-blur-sm p-4 text-white">
      ...
      <p>If anyone at Critical Role or Darrington Press sees this, please let us know if you have any feedback or suggestions! Thank you for visiting! email: <a href="mailto:hello@voxoradigital.com">hello@voxoradigital.com</a></p>
    </footer>
  );
};
