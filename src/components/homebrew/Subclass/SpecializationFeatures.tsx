...
interface SpecializationFeaturesProps {
  form: UseFormReturn<NewSubclassFormData>;
}

const SpecializationFeatures = ({
  form,
}: SpecializationFeaturesProps): JSX.Element => {
  ...
  const addFeature = () => {
    ...
    form.setValue("features.specialization", newFeatures);
  };
...
export default SpecializationFeatures;
