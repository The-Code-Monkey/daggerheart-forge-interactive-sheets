...
interface MasteryFeaturesProps {
  form: UseFormReturn<NewSubclassFormData>;
}

const MasteryFeatures = ({ form }: MasteryFeaturesProps): JSX.Element => {
  ...
  const addFeature = () => {
    ...
    form.setValue("features.mastery", newFeatures);
  };
...
export default MasteryFeatures;
