...
import { Sword, Shield, Zap, Heart, User, Book, Sparkles, Dice6 } from "lucide-react";
...
const GameRules = () => {
  ...
  const ancestries = [
    { name: "Human", description: "Versatile and adaptable beings" },
    { name: "Drakona", description: "Dragon-descended folk with elemental heritage" },
    { name: "Faerie", description: "Magical beings from the realm of dreams" },
    { name: "Dwarf", description: "Hardy mountain folk skilled in craftsmanship" },
    { name: "Elf", description: "Graceful beings with deep magical connections" },
    { name: "Giant", description: "Towering people with incredible strength" },
    { name: "Halfling", description: "Small folk known for their courage and luck" },
    { name: "Orc", description: "Proud warriors with strong tribal bonds" },
    { name: "Ribbet", description: "Amphibious people who value community" }
  ];
          ...
          <TabsContent value="classes" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {classes.map((cls, index) => (
                <Card key={index} className="bg-gradient-to-br from-purple-800/40 to-slate-800/40 border-purple-500/30 backdrop-blur-sm">
                  <CardHeader>
